...
function AnimatedInputOTPSlot({ index, className }: AnimatedInputOTPSlotProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative flex h-14 w-12 items-center justify-center rounded-xl border border-border bg-muted/20 text-xl shadow-sm outline-none transition-all aria-invalid:border-destructive data-[active=true]:z-10 data-[active=true]:border-ring data-[active=true]:ring-ring/50 data-[active=true]:aria-invalid:border-destructive data-[active=true]:aria-invalid:ring-destructive/20 dark:data-[active=true]:aria-invalid:ring-destructive/40",
        className,
      )}
