    ...
    <section>
      <div className="py-24 md:py-32">
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-12 px-6 md:grid-cols-2 md:items-center">
          <div className="aspect-16/10 group relative mx-auto flex w-full max-w-[22rem] items-center justify-between sm:max-w-sm md:mx-0">
            <div
              role="presentation"
              className="bg-gradient-to-b border-foreground/5 absolute inset-0 z-10 aspect-square animate-spin items-center justify-center rounded-full border-t from-lime-500/15 to-transparent to-25% opacity-0 duration-[3.5s] group-hover:opacity-100 dark:from-white/5"
            ></div>
            <div
              role="presentation"
              className="bg-gradient-to-b border-foreground/5 absolute inset-16 z-10 aspect-square scale-90 animate-spin items-center justify-center rounded-full border-t from-blue-500/15 to-transparent to-25% opacity-0 duration-[3.5s] group-hover:opacity-100"
            ></div>
          ...
          <div className="relative z-20 mx-auto max-w-lg space-y-6 text-center md:text-left">
