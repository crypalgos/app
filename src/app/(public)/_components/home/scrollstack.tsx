      ...
      <ScrollStack>
        <ScrollStackItem>
          <div className="space-y-4 md:space-y-6">
            <div className="inline-flex items-center px-3 py-1 md:px-4 md:py-1.5 rounded-full bg-primary/10 border border-primary/20 text-[10px] md:text-xs font-black uppercase tracking-widest text-primary">
              Visual Builder
            </div>
        ...
        <ScrollStackItem>
          <div className="space-y-4 md:space-y-6">
            <div className="inline-flex items-center px-3 py-1 md:px-4 md:py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-[10px] md:text-xs font-black uppercase tracking-widest text-blue-500">
              Backtesting
            </div>
            <h2 className="text-3xl md:text-6xl font-black italic uppercase tracking-tighter leading-none">
              Validate With <br />
        ...
        <ScrollStackItem>
          <div className="space-y-4 md:space-y-6">
            <div className="inline-flex items-center px-3 py-1 md:px-4 md:py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[10px] md:text-xs font-black uppercase tracking-widest text-emerald-500">
              Live Execution
            </div>
            <h2 className="text-3xl md:text-6xl font-black italic uppercase tracking-tighter leading-none">
              Execute With <br />
