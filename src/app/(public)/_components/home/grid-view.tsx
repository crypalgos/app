...
export function GridView() {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4  relative z-10 py-6 md:py-10 max-w-7xl mx-auto">
...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 relative z-10 px-5 md:px-10 text-neutral-600 dark:text-neutral-400">
        {icon}
      </div>
      ...
      <p className="text-sm text-neutral-600 dark:text-neutral-300 max-w-xs relative z-10 px-5 md:px-10">
        {description}
      </p>
    </div>
  );
