        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-balance text-muted-foreground text-lg font-medium opacity-80">
              Institutional-grade pricing designed for quant traders and funds. Scale your
              algorithmic portfolio with confidence.
            </p>
            <div className="my-12">
              <div
              ...
              <div className="grid grid-cols-1 gap-6 *:p-8 md:grid-cols-3">
                ...
                >
                  <div className="card-content relative z-10 flex h-full flex-col">
                    ...
                    <p className="mb-6 grow text-foreground/70 text-sm leading-relaxed">
                      Essential tools for automated crypto trading. Backtest and deploy your first strategies.
                    </p>
                    {/* What's Included */}
                    <div className="space-y-4">
                      ...
                      <ul className="space-y-3">
                        {[
                          "2 Active Strategies",
                          "Daily Backtesting Data",
                          "Standard Exchange Integrations",
                ...
                >
                  ...
                  <div className="card-content relative z-10 flex h-full flex-col">
                    ...
                    <div className="mb-6">
                      ...
                      <span className="mx-2 text-foreground/70">•</span>
                      <span className="text-foreground/70">Best for quant teams</span>
                    </div>
                    {/* CTA Button */}
                    <button
                      className="mb-6 inline-flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-md bg-foreground px-4 py-2 font-medium text-background text-sm transition-colors hover:bg-foreground/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                    ...
                    {/* Description */}
                    <p className="mb-6 grow text-foreground/70 text-sm leading-relaxed">
                      Advanced infrastructure for high-frequency trading. Everything you
                      need to scale your portfolio execution.
                    </p>
                    {/* What's Included */}
                    <div className="space-y-4">
                      <h4 className="font-medium text-foreground/70 text-xs uppercase tracking-wider">
                      ...
                      <ul className="space-y-3">
                        {[
                          ...
                          "Tick-level Backtesting Data",
                          "Premium API Access (WebSocket)",
                ...
                >
                  <div className="card-content relative z-10 flex h-full flex-col">
                    ...
                    {/* Description */}
                    <p className="mb-6 grow text-foreground/70 text-sm leading-relaxed">
                      Institutional-grade execution architecture, custom data pipelines, 
                      and dedicated engineering support for hedge funds.
                    </p>
                    {/* What's Included */}
                    <div className="space-y-4">
                      <h4 className="font-medium text-foreground/70 text-xs uppercase tracking-wider">
