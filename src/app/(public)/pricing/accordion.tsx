        ...
        <div className="w-full max-w-3xl mx-auto py-10 md:py-16 px-4">
            ...
            <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                    <AccordionTrigger className="text-left">How secure are the exchange API connections?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-2">
                    <AccordionTrigger className="text-left">Can I backtest my strategies before trading live?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-3">
                    <AccordionTrigger className="text-left">What exchanges do you support?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-4">
                    <AccordionTrigger className="text-left">Do I need coding skills to use the trading bots?</AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-5">
                    <AccordionTrigger className="text-left">What happens if I upgrade or downgrade my plan?</AccordionTrigger>
                    <AccordionContent>
