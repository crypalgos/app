    ...
    <div className="flex min-h-screen w-full bg-background relative overflow-hidden">
      <div className="hidden lg:flex relative w-1/2 flex-col items-center justify-center p-12 overflow-hidden border-r border-border bg-card/20 group">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/professional_trading_dashboard_1771178212028.png"
            alt="Trading Dashboard"
            fill
            className="object-cover opacity-35 dark:opacity-45 mix-blend-luminosity grayscale contrast-125 transition-opacity duration-700"
          />
      ...
      <div className="flex-1 relative flex flex-col items-center justify-center p-4 min-h-screen overflow-y-auto">
        {/* Mobile Logo Only */}
        ...
        <div className="relative z-10 w-full max-w-md mx-auto py-20 lg:py-0">
          {children}
        </div>
      </div>
    </div>
