            ...
            <tbody>
              {windows.map((w) => (
                <tr key={w.window_id} className="border-b border-border/20 hover:bg-muted/20 cursor-pointer" onClick={() => setSelected(w)}>
                  ...
                  <td className="px-3 py-2.5 text-[10px] text-muted-foreground">{w.train_start} → {w.train_end}</td>
                  <td className="px-3 py-2.5 text-[10px] text-muted-foreground">{w.validation_start} → {w.validation_end}</td>
                  <td className="px-3 py-2.5">
                    <Badge className="text-[9px] font-bold px-1.5 py-0 bg-muted/80 text-muted-foreground border-transparent">{w.regime}</Badge>
                  </td>
            ...
            <>
              ...
              <ScrollArea className="flex-1">
                <div className="p-6 flex flex-col gap-5">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold mb-2">Train vs Validation</p>
                  ...
                  {selected.evaluation.reasons.length > 0 && (
                    <div>
                      <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold mb-2">Why It {selected.evaluation.passed ? "Passed" : "Failed"}</p>
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold mb-2">Parameters Used</p>
